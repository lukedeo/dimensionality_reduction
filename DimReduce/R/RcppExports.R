...
INTERNAL_BOXCOX <- function(D, A, X1, cmds_start = 1L, random_start = 0L, d = 3L, lambda = 1, mu = 1, nu = 0, tau = 1, niter = 1000L, sample_rate = 100L, bfgs = 0L, adaptive = 1L, scale_out = 1L) {
    .Call('DimReduce_INTERNAL_BOXCOX', PACKAGE = 'DimReduce', D, A, X1, cmds_start, random_start, d, lambda, mu, nu, tau, niter, sample_rate, bfgs, adaptive, scale_out)
}
